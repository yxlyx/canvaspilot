...
fn renderLive(req: mer.Request) mer.Response {
    ...
    for (meters) |meter| {
        ...
        w.print("</ul><aside class=\"cp-recommendation wb-m3-recommendation\"><h3>Compatibility notice</h3><p>{s}</p><div class=\"cp-action-row wb-m3-actions\"><a class=\"cp-btn cp-btn-ghost\" href=\"/dashboard\">Choose a module dashboard</a></div></aside></article>", .{lib.ui.escapeSafe(req.allocator, meter.recommendation)}) catch return mer.internalError("meter render failed");
    }
