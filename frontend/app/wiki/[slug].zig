...
fn renderLiveReader(req: mer.Request, page: lib.types.WikiPageResponse, now_secs: i64) mer.Response {
    ...
    w.print("<main id=\"main\" tabindex=\"-1\" class=\"reader-page\" data-cp-document-title=\"{s}\"><header class=\"reader-header\"><a class=\"reader-brand\" href=\"{s}\">{s}<span class=\"cp-brand-mark\">W</span><span>Knowledge wiki</span></a><div class=\"reader-tools\"><button id=\"cp-save-article\" type=\"button\">{s}<span>Save article</span></button><button id=\"cp-copy-article\" type=\"button\">{s}<span>Copy link</span></button><button type=\"button\" data-cp-theme-toggle aria-label=\"Switch to dark mode\">{s}</button></div><a class=\"button button-dark button-small\" href=\"{s}\">Ask about this topic</a></header>", .{ safe_title, wiki_href, ICON_BACK, ICON_SAVE, ICON_LINK, ICON_MOON, chat_href }) catch return mer.internalError("wiki render failed");
    w.print("<section class=\"cp-export-bar\"><form method=\"post\" action=\"/api/m3\" data-page-download data-slug=\"{s}\"><button class=\"button button-secondary button-small\" type=\"submit\">Download canonical Markdown</button><span class=\"cp-form-status\" role=\"status\" aria-live=\"polite\"></span></form></section><script src=\"/m3.js?v=20260721\" defer></script>", .{safe_slug}) catch return mer.internalError("wiki export render failed");
...
fn renderMockReader(req: mer.Request, page: lib.types.WikiPage, now_secs: i64) mer.Response {
    ...
    const when = lib.time.formatRelative(req.allocator, page.updated_at, now_secs) catch "—";
    const safe_title = lib.ui.escapeSafe(req.allocator, page.title);
    w.print("<main id=\"main\" tabindex=\"-1\" class=\"reader-page\" data-cp-document-title=\"{s}\"><header class=\"reader-header\"><a class=\"reader-brand\" href=\"{s}\">{s}<span class=\"cp-brand-mark\">W</span><span>Knowledge wiki</span></a><div class=\"reader-tools\"><button id=\"cp-copy-article\" type=\"button\">{s}<span>Copy link</span></button><button type=\"button\" data-cp-theme-toggle aria-label=\"Switch to dark mode\">{s}</button></div><a class=\"button button-dark button-small\" href=\"{s}\">Ask about this topic</a></header><section class=\"cp-export-bar\"><button class=\"button button-secondary button-small\" type=\"button\" disabled>Download canonical Markdown</button><span>Export is unavailable in synthetic demo mode.</span></section>", .{ safe_title, wiki_href, ICON_BACK, ICON_LINK, ICON_MOON, chat_href }) catch return mer.internalError("wiki render failed");
...
fn renderMissing(req: mer.Request, slug: []const u8, demo: bool) mer.Response {
    ...
    w.print("<main id=\"main\" tabindex=\"-1\" class=\"reader-page reader-missing\" data-cp-document-title=\"Page not generated yet\"><section class=\"empty-state surface\"><p class=\"eyebrow\">Knowledge wiki</p><h1>Page not generated yet</h1><p>{s} <strong>{s}</strong>.</p><a class=\"button button-dark\" href=\"{s}\">Browse wiki pages</a></section></main>", .{ missing_copy, safe_slug, wiki_href }) catch return mer.internalError("wiki render failed");
